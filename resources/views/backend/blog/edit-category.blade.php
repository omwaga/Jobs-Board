		...
		<div class="page-inner">
			<div class="page-header">
				...
				<ul class="breadcrumbs">
					...
					<li class="nav-item">
						<a href="#">Edit {{$blogcategory->name}}</a>
					</li>
				</ul>
			</div>
			<div class="row">
				<div class="col-lg-12">
					<div class="card">
						<div class="card-header">
							<div class="card-title">Edit Category - {{$blogcategory->name}}</div>
						</div>
						<div class="card-body">
							<form method="Post" action="{{route('admin.blogcategories.update', $blogcategory->id)}}" enctype="multipart/form-data">
								@csrf
								@method('PATCH')
								
								<div class="form-group">
									<label for="email2">Name</label>
									<input class="form-control" name="name" type="text" required value="{{$blogcategory->name}}" />
								</div>
								<div class="form-group">
