      ...
      <div class="d-flex">
        ...
        <div class="float-right pt-1">
          <small class="text-muted">
            <button type="button" @mouseover="editInternship(internship.id)" class="btn btn-primary btn-sm" data-toggle="modal" :data-target="'#editinternship-'+index">
              <i class="fas fa-edit"></i> Edit
            </button>
          </small>
          <small class="text-muted">
            <button @click="deleteInternship(internship.id)" class="btn btn-danger btn-sm">
